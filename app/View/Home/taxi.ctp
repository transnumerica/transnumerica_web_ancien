                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="mx-0 mt-3 d-flex justify-content-center">
                                            <div class="btn btn-primary border-white rounded-pill  py-2 px-3 mx-0 btn-recherche recherche-taxi">Rechercher</div>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="container-fluid py-2 my-4 image-shadow bg-black-transparent" >
            <div class="container py-2">
                <div class="text-center mx-auto pb-2 wow fadeInUp" data-wow-delay="0.5s" style="max-width: 800px;">
                    <h2 class="display-6 text-capitalize my-3 text-white">Liste des Taxis</h2>
...
<div class="modal fade" id="reservationModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="reservationModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-primary" id="reservationModalLabel">Réservation du Taxi <span class="operator-name"></span></h5>
        ...
        <div class="modal-body">
          <div class="container">
            ...
            <div class="p-3 mb-3 container-hour-price rounded border-primary border-light bg-white">
              <div class="d-flex justify-content-center mb-2"><h4 class="text-primary ">Nbr Heures : </h4><h4 class="text-primary hour-price"></h4></div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary btn-acheter-billet-taxi">Acheter</button>
        </div>
...
<script src="/js/main-taxi.js?<?php echo time(); ?>"></script>