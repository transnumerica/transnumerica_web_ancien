  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-primary" id="reservationModalLabel">Réservation du Bus <span class="operator-name"></span></h5>
      ...
      <div class="modal-body">
        <div class="container">
          ...
          <div class="p-3 mb-3 rounded border-primary border-light bg-white">
            ...
            <div class="d-flex justify-content-center"><input id="datepicker" class="border-grey border-light p-1 px-3 datepicker-bootstrap" width="270" /></div>
          </div> 
          ...
          <div class="p-3 mb-3 rounded border-primary border-light bg-white">
            ...
            -->
          <div class="p-3 mb-3 container-place-price rounded border-primary border-light bg-white">
            <div class="d-flex justify-content-center mb-2"><h4 class="text-primary me-1">Nbr places :</h4><h4 class="text-primary place-price"></h4><h4 class="text-primary ms-1">(</h4><h4 class="text-primary place-nbr-total"></h4><h4 class="text-primary ms-1 me-1">places)</h4></div>
          ...
          <div class="container-total p-3 mb-3 rounded border-primary border-light bg-white">
            ...
            <div class="d-flex justify-content-center">
            <div class="d-flex"><h4 class="me-1">Total : </h4><h4 class="total"></h4></div>
            </div>
          </div> 
...
<script src="/js/main-bus.js?<?php echo time(); ?>"></script>