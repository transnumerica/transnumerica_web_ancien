        ...
        <nav id="menu" class="res-menu">
            <ul>
                ...
                <li>
                    ...
                    <a href="<?php echo Router::url(array('controller' => 'profil', 'action' => 'view', 'slug' => mb_strtolower(Inflector::slug($AuthUser['Account']['fullname'])), 'id' => $AuthUser['Info']['id'])) ?>" title=""><i class="ti-user"></i> Profil</a>
                </li>

                <li>
                    <a href="<?php echo Router::url(array('controller' => 'messages', 'action' => 'index')) ?>" title=""><i class="ti-comments"></i> Message</a>
                </li>

                <li>
                    <a href="<?php echo Router::url(array('controller' => 'profil', 'action' => 'transactions', 'slug' => mb_strtolower(Inflector::slug($AuthUser['Account']['fullname'])), 'id' => $AuthUser['Info']['id'])) ?>" title=""><i class="fa fa-money"></i> E-Banking</a>
                </li>

                <li>
                    <a href="#" title=""><i class="fa fa-users"></i> Groupes</a>
                </li>

                <li>
                    <a href="<?php echo Router::url(array('controller' => 'profil', 'action' => 'edit', 'slug' => mb_strtolower(Inflector::slug($AuthUser['Account']['fullname'])), 'id' => $AuthUser['Info']['id'])) ?>" title=""><i class="ti-settings"></i> Paramètre</a>
                </li>

                <li>
                    <a href="<?php echo Router::url(array('controller' => 'about', 'action' => 'cgv')) ?>" title=""><i class="fa fa-sitemap"></i> Conditions Générales</a>
                </li>
            </ul>
        </nav>
        <!--nav id="shoppingbag">
    ...
    <!-- topbar -->
        <?php echo $this->element('topbar2') ?>
    <!-- endtopbar -->    


    <!-- left sidebar menu -->
        <?php //echo $this->element('fixed-left-sidebar') ?>
    <!-- left sidebar menu -->    
