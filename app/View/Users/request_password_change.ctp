				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
						...
						<div class="color-inherit users form">
							...
							<h2 class="main-title">Mot de passe oublié ?</h2>
							...
							<div class="editing-info" style="margin-top: 35px;">
								<!--h5 class="f-title"><i class="ti-info-alt"></i>Information du Profil</h5-->
									...
									<h6>Veuillez saisir l'adresse e-mail que vous avez utilisée pour vous inscrire et vous recevrez un e-mail contenant des instructions supplémentaires</h6>

									<div class="form-group row">
									    <label class="col-form-label col-lg-2">E-mail</label>
									    <div class="col-lg-10">
									        <?php echo $this->Form->input('User.email', array('required' => 'required', 'id' => 'emailInput')); ?>
										</div>
									</div>
