<?php
include ROOT . DS . 'app' . DS . 'Plugin' . DS . ucfirst($this->request->plugin) . DS . 'Lib' . DS . 'PHPExcel' . DS . 'PHPExcel.php';
include ROOT . DS . 'app' . DS . 'Plugin' . DS . ucfirst($this->request->plugin) . DS . 'Lib' . DS . 'PHPExcel' . DS . 'PHPExcel' . DS . 'Writer' . DS . 'Excel2007.php';
